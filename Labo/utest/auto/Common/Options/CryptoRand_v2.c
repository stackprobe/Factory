...
static void DoTest_01_2(void)
{
	...
	seed    = readBinary("C:\\Factory\\tmp\\CSeed_v2.dat");
	seedCa  = readBinary("C:\\Factory\\tmp\\CSeedCa_v2.dat");
	seedCa2 = readBinary("C:\\Factory\\tmp\\CSeedCa2_v2.dat");
	seedCa3 = readBinary("C:\\Factory\\tmp\\CSeedCa3_v2.dat");
	...
	rSeed    = readBinary("C:\\Factory\\tmp\\CSeed_v2.dat");
	rSeedCa  = readBinary("C:\\Factory\\tmp\\CSeedCa_v2.dat");
	rSeedCa2 = readBinary("C:\\Factory\\tmp\\CSeedCa2_v2.dat");
	rSeedCa3 = readBinary("C:\\Factory\\tmp\\CSeedCa3_v2.dat");
...
#undef CR_FILE
	...
	cr2_c1 = GetCr2_Ca(0x00, "C:\\Factory\\tmp\\CSeed_v2.dat");
	cr2_c2 = GetCr2_Ca(0x40, "C:\\Factory\\tmp\\CSeedCa_v2.dat");
	cr2_c3 = GetCr2_Ca(0x80, "C:\\Factory\\tmp\\CSeedCa2_v2.dat");
	cr2_c4 = GetCr2_Ca(0xc0, "C:\\Factory\\tmp\\CSeedCa3_v2.dat");
