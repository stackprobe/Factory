...
void *CreateTelnetServerPerformInfo(void); // external
void ReleaseTelnetServerPerformInfo(void *); // external
...
*/
char *TelnetServerPerform(char *inputLine, void *vi); // external
